...
namespace AccesoDatos
{
    public class SqlServer : GDatos
    {
        ...
        protected override System.Data.IDbCommand Comando(string procedimientoAlmacenado)
        {
            ...
            com.Connection = (System.Data.SqlClient.SqlConnection)MConexion;
        ...
        {
            var com = new System.Data.SqlClient.SqlCommand(comandoSql, (System.Data.SqlClient.SqlConnection)MConexion, (System.Data.SqlClient.SqlTransaction)MTransaccion);
            return com;
        }// end Comando
