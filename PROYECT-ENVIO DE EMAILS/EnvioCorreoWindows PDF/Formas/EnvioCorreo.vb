...
#End Region
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Dim sSel As String = "SELECT CODIGO = LEFT(RESUMEN.CODIGO,11), NOMBRE_CLIENTE = RTRIM(LTRIM(MAX(RESUMEN.NOMBRE_CLIENTE))), EMAIL = RTRIM(LTRIM(MAX(RESUMEN.EMAIL))) FROM (" + _
        ...
        '                             " ) AS RESUMEN where LEFT(RESUMEN.CODIGO,11) in (" + ") GROUP BY LEFT(RESUMEN.CODIGO,11)  "
